...
features:
  - title: 先讲工作流
    details: "先回答怎么用：登录、提交 URL 或上传本地音视频 / 文字稿、轮询任务、保存笔记、继续编辑。"
  - title: 不重复造轮子
...
- VINote 是什么
- 用户工作流是什么，以及 URL / 本地上传 / 文字稿直传分别怎么走
- 认证怎么接
- 不同 API 分组该怎么理解
- MCP 和本地部署怎么接入
...
4. [API Key](/api/api-keys)
5. [生成笔记](/api/generate-note)
6. [任务状态](/api/task-status)
7. [已保存笔记](/api/saved-notes)
