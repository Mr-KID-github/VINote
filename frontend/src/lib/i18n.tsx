...
const messages = {
  en: {
    ...
    meetingRecorder: {
      ...
      processingHint: 'Generating minutes after recording ends.',
    ...
    meetingRecorder: {
      title: 'Meeting recording',
      openPanel: 'Start meeting recording',
      restore: 'Restore meeting recording',
      minimize: 'Minimize',
      close: 'Close',
      start: 'Start',
      stop: 'Stop',
      ...
      minimizedDragHandle: 'Drag minimized meeting recording',
      popout: 'Pop out recorder window',
      popoutTitle: 'VINote meeting recorder',
      processingHint: 'Processing meeting recording',
      completedNotice: 'Meeting note is ready',
      saveFailed: 'Meeting summary was generated but could not be saved.',
      unknownError: 'Unknown recording error',
      modelConfigRequired: 'Configure usable LLM and STT API keys before generating meeting notes.',
      microphoneDenied: 'Microphone permission is blocked. Enable microphone access and try again.',
      microphoneUnavailable: 'Microphone is busy or unavailable. Check the device and try again.',
      microphoneNoAudio: 'No available microphone input was found.',
      unsupported: 'This browser does not support audio recording.',
      beforeUnload: 'Meeting recording data may be lost if you leave this page.',
      discardTitle: 'Discard this meeting recording?',
      discardBody: 'Recorded audio is hard to reproduce. Keep the recording or finish generating the note before closing.',
  ...
  'zh-CN': {
    ...
    meetingRecorder: {
      ...
      doneTitle: '会议已总结好',
      failedTitle: '会议总结失败',
      processingHint: '结束录音后正在自动生成会议纪要。',
    ...
    meetingRecorder: {
      ...
      popout: '弹出独立录音窗口',
      popoutTitle: 'VINote 会议录音',
      processingHint: '正在处理会议录音',
      completedNotice: '会议纪要已生成',
      saveFailed: '会议纪要已生成，但保存到笔记库失败。',
      unknownError: '未知录音错误',
      modelConfigRequired: '请先配置可用的 LLM 和 STT API Key，再生成会议纪要。',
      microphoneDenied: '麦克风权限已被拒绝或阻止，请允许麦克风访问后重试。',
      microphoneUnavailable: '麦克风正被占用或不可用，请检查设备后重试。',
      microphoneNoAudio: '未检测到可用的麦克风输入设备。',
      unsupported: '当前浏览器不支持会议录音。',
      beforeUnload: '离开页面可能导致会议录音数据丢失。',
      discardTitle: '放弃这段会议录音？',
      discardBody: '会议录音很难重新获得。建议先结束录音并生成纪要；如果确认放弃，已录内容将被清除。',
      keepRecording: '继续保留',
      discard: '放弃录音',
