...
const messages = {
  en: {
    ...
    apiKeys: {
      title: 'API Keys',
      body: 'Create keys for scripts and integrations that call the protected `/api/v1` generation endpoints.',
      loading: 'Loading...',
      empty: 'No API key yet. Create one when you are ready to connect an external tool.',
      createdTitle: 'Copy this key now',
      createdBody: 'For security, the full key is shown only once. Store it before leaving this page.',
      copy: 'Copy',
      copied: 'Copied',
      dismiss: 'Done',
      createTitle: 'Create API key',
      createBody: 'Keys inherit your default model and STT profiles when used with `/api/v1`.',
      name: 'Name',
      namePlaceholder: 'Zapier, CLI, backend worker',
      create: 'Create key',
      saving: 'Saving...',
      prefix: 'Prefix:',
      createdAt: 'Created:',
  ...
  'zh-CN': {
    ...
    apiKeys: {
      title: 'API Key',
      body: '创建给脚本和集成使用的密钥，用于调用受保护的 `/api/v1` 生成接口。',
      loading: '加载中...',
      empty: '还没有 API Key。需要连接外部工具时，可以先创建一个。',
      createdTitle: '现在复制这个密钥',
      createdBody: '出于安全考虑，完整密钥只会显示一次。离开页面前请妥善保存。',
      copy: '复制',
      copied: '已复制',
      dismiss: '完成',
      createTitle: '创建 API Key',
      createBody: '使用 `/api/v1` 时，密钥会继承你的默认模型和 STT 配置。',
      name: '名称',
      namePlaceholder: 'Zapier、CLI、后端任务',
      create: '创建密钥',
      saving: '保存中...',
      prefix: '前缀：',
      createdAt: '创建时间：',
